// once again copy pasted modified from
// .../subsystems/elevator/simulation/SimulatedElevatorConfiguration.java
package com.aembot.lib.config.subsystems.turret.simulation;

public class SimulatedTurretConfiguration {
