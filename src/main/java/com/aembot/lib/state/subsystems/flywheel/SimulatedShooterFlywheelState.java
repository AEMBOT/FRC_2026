...
public class SimulatedShooterFlywheelState implements Loggable {
  ...
  private List<Pose3d> loggedTrajectory;
            ...
            new RebuiltFuelOnFly(
                ...
                Angle.ofBaseUnits(
                    gamePieceExitPoint
                        ...
                        .getY(),
                    Radians)).withProjectileTrajectoryDisplayCallBack((trajectory) -> loggedTrajectory = trajectory));
  ...
  public void updateLog(String standardPrefix, String inputPrefix) {
    Logger.recordOutput(standardPrefix + "/SimulatedShotTrajectory", loggedTrajectory.toArray(new Pose3d[0]));
  }
}
