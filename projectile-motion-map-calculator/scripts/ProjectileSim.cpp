...
ProjectileSim::ProjectileSim(Vector3D initPos, Vector3D initVel, bool useDrag) {
...
void ProjectileSim::SimulateStep() {
	...
	Vector3D k1_a = k1_s.getAcceleration(usesDrag);
	...
	Vector3D k2_a = k2_s.getAcceleration(usesDrag);
	...
	Vector3D k3_a = k3_s.getAcceleration(usesDrag);
	...
	Vector3D k4_a = k4_s.getAcceleration(usesDrag);
